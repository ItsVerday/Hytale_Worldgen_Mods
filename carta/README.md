# Carta
Carta is a Hytale Plugin that allows for Biomes to be placed in a much more powerful and customizable way than in Vanilla.
It accomplishes this by adding a new WorldStructure type, `Carta`, as well as a new `BiomeProvider` asset type, which returns a biome to be placed at a given location.
